# adpated from https://github.com/huggingface/diffusers/blob/v0.27.2/src/diffusers/pipelines/stable_diffusion_xl/pipeline_stable_diffusion_xl.py
import torch
...
class DistriStableDiffusionXLPiP(StableDiffusionXLPipeline):
