...
from pipefuser.model_executor.pipelines import PipeFuserPixArtAlphaPipeline
...
def main():
    ...
    pipe.set_input_config(input_config)
    pipe.prepare_run()
    ...
    output = pipe(
        ...
        num_pipeline_warmup_steps=input_config.warmup_steps,
