...
from lagecy.pipefuser.modules.dit.tensor_parallel.attention import DistriAttentionTP
from lagecy.pipefuser.modules.dit.tensor_parallel.conv2d import DistriConv2dTP
from lagecy.pipefuser.modules.dit.tensor_parallel.feed_forward import DistriFeedForwardTP
from lagecy.pipefuser.modules.dit.tensor_parallel.resnet import DistriResnetBlock2DTP
        ...
        if distri_config.use_cuda_graph and not record:
            ...
            if distri_config.world_size == 1:
                ...
                dist.all_gather(
                    self.buffer_list,
                    output.contiguous(),
                    group=distri_config.local_dp_group(),
                    async_op=False,
                )
