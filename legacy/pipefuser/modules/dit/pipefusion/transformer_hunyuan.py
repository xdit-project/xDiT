...
class DistriHunyuanTransformer2DModel(BaseModule):
    def __init__(self, module: HunyuanDiT2DModel, distri_config: DistriConfig):
        ...
        if distri_config.attn_num is not None:
            ...
            if current_rank == 0:
                self.module.blocks = self.module.blocks[: distri_config.attn_num[0]]
            else:
            ...
            end_idx = min(block_len * (current_rank + 1), len(self.module.blocks))
    ...
    def forward(
        ...
        encoder_hidden_states = torch.where(
            text_embedding_mask, encoder_hidden_states, module.text_embedding_padding
        )
