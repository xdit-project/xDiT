...
from legacy.pipefuser.pipelines.pip.distri_hunyuandit import DistriHunyuanDiTPiP
from legacy.pipefuser.schedulers.pip.dpmsolver_multistep import (
    DPMSolverMultistepSchedulerPiP,
)
from legacy.pipefuser.schedulers.pip.ddim import DDIMSchedulerPiP
from legacy.pipefuser.schedulers.pip.ddpm import DDPMSchedulerPiP
    ...
    def prepare(self, **kwargs):
        ...
        if distri_config.parallelism == "pipefusion":
            ...
            latent_model_input = (
                ...
                and not distri_config.split_batch
                else latents
            )
            ...
            if pipeline.transformer.config.sample_size == 128:
                ...
                if (
                    distri_config.do_classifier_free_guidance
                    and not distri_config.split_batch
                ):
