...
from legacy.pipefuser.pipelines.hunyuandit import DistriHunyuanDiTPipeline
...
def main():
    ...
    parser.add_argument(
        ...
        default="pipefusion",
        type=str,
        choices=["origin", "patch", "naive_patch", "pipefusion", "tensor", "sequence"],
