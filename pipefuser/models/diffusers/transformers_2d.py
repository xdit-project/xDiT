# adapted from https://github.com/huggingface/diffusers/blob/v0.27.2/src/diffusers/models/transformers/transformer_2d.py
...
from pipefuser.models.diffusers.attention import BasicTransformerBlock
