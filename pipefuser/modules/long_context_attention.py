...
from pipefuser.distributed import get_runtime_state


class PipeFuserLongContextAttention(LongContextAttention):
    """Initialization.
        ...
        if self.use_kv_cache:
            ...
            if not get_runtime_state().patch_mode:
                ...
                if self.kv_cache is None:
                    raise ValueError(
                        "PipeFuserLongContextAttention kvcache is None in patch mode"
                    )
