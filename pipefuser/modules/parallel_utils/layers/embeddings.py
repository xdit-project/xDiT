...
from pipefuser.modules.parallel_utils.layers.base_layer import PipeFuserLayerBaseWrapper
from pipefuser.modules.parallel_utils.layers.register import PipeFuserLayerWrappers
...
@PipeFuserLayerWrappers.register(PatchEmbed)
