...
from pipefuser.modules.dit.pipefusion import DistriSD3CNTransformer2DModel
                ...
                if distri_config.rank == 1 and i == 0:
                    ...
                    if distri_config.rank != 1:
                        ...
                        for items in range(len(next_control_block_samples)):
                            print(items)
                            next_control_block_samples[items] = (
                                self.comm_manager.recv_from_prev(
                                    prompt_embeds.dtype, is_extra=True
                                )
                            )
