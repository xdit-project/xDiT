...
from pipefuser.pipelines.pip.distri_sd3_cn import DistriSD3CNPiP
...
class DistriSD3CNPipeline:
    def __init__(
        self, pipeline: StableDiffusion3ControlNetPipeline, module_config: DistriConfig
    ):
    ...
    def from_pretrained(distri_config: DistriConfig, **kwargs):
        ...
        controlnet = SD3ControlNetModel.from_pretrained(
            "InstantX/SD3-Controlnet-Canny", torch_dtype=torch_dtype
        )
