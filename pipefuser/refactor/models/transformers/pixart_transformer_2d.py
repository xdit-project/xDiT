...
from pipefuser.refactor.models.transformers import PipeFuserTransformerBaseWrapper
...
@PipeFuserTransformerWrappersRegister.register(PixArtTransformer2DModel)
class PipeFuserPixArtTransformer2DWrapper(PipeFuserTransformerBaseWrapper):
    def __init__(
        self,
