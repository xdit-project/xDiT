# copy from https://github.com/huggingface/diffusers/blob/v0.27.2/src/diffusers/models/attention.py
...
from distrifuser.models.diffusers.attention_processor import Attention
