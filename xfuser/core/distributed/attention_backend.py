...
# The FlyDSL custom ops moved to xfuser/core/attention/backends/aiter_flydsl.py,
# which registers them. The legacy backends below still reach them through
# torch.ops.xfuser.*; both modules are imported in every path that uses either.
