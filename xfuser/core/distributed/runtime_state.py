...
import numpy as np
import torch
from diffusers import DiffusionPipeline, CogVideoXPipeline, CogVideoXImageToVideoPipeline
...
class DiTRuntimeState(RuntimeState):
    ...
    def __init__(self, pipeline: DiffusionPipeline, config: EngineConfig):
        ...
        if isinstance(pipeline, CogVideoXPipeline) or isinstance(pipeline, CogVideoXImageToVideoPipeline):
