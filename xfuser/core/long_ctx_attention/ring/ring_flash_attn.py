...
from xfuser.core.distributed import get_runtime_state, runtime_state_is_initialized
...
def xdit_ring_flash_attn_forward(
    ...
    if runtime_state_is_initialized() and get_runtime_state().num_pipeline_patch > 1 and attn_layer is not None:
