...
class xFuserLTX23VideoModel(xFuserModel):
    ...
    def _run_pipe(self, input_args: dict) -> DiffusionOutput:
        ...
        video_latent, audio_latent = self.pipe(
            ...
            stg_scale=input_args.get("stg_scale"),
            spatio_temporal_guidance_blocks=input_args.get("spatio_temporal_guidance_blocks"),
            modality_scale=input_args.get("modality_scale"),
            guidance_rescale=input_args.get("guidance_rescale"),
            audio_guidance_scale=input_args.get("audio_guidance_scale"),
            audio_stg_scale=input_args.get("audio_stg_scale"),
            audio_modality_scale=input_args.get("audio_modality_scale"),
            audio_guidance_rescale=input_args.get("audio_guidance_rescale"),
