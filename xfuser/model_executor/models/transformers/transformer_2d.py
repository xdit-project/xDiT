...
from xfuser.model_executor.models.transformers import xFuserTransformerBaseWrapper
...
@xFuserTransformerWrappersRegister.register(Transformer2DModel)
class xFuserTransformer2DWrapper(xFuserTransformerBaseWrapper):
    def __init__(
        self,
